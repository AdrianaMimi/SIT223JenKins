...
const BOX_W = 900, BOX_H = 300;
const STAGE_W = 950, STAGE_H = 560;
...
export default function KonvaBanner({ open, onClose, file, imageURL, onExport }) {
    ...
    const exportRegion = () => {
        ...
        try {
            ...
            a.href = uri; a.download = "export_900x300.webp"; a.click();
        } catch (e) {
